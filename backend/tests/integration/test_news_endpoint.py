...
from src.news.schemas import  NewsSummaryCustomModelRequestSchema,PromptRequest,NewsSumaryRequestSchema
...
def mock_openai(mocker, return_content):
    mock_generate = mocker.patch('src.llm_client.openai_client.LLMClient._generate', autospec=True)
...
def test_news_summary(mocker, test_token):
    ...
    request_body =  NewsSummaryCustomModelRequestSchema(content="Test news content")
